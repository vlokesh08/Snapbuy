  ...
  return (
    <div className="w-full relative group">
      <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow">
            <a href="#">
                <img class="w-[270px] h-[300px] p-8 rounded-t-lg" src={props.img} alt="product image" />
                {/* <Image className="w-full h-full" imgSrc={props.img} /> */}

            </a>
            <div class="px-5 pb-5">
                <a href="#">
                    <h5 class="text-xl font-semibold tracking-tight text-gray-900">{props.productName}</h5>
                </a>
